...
3. **RESOLVED-BY-SIDE-EFFECT triage sweep.** 9 OPEN at
   `docs/testing/playtest/runs/2026-04-29-2139-3p/issues/`, 2 OPEN at
   `docs/testing/playtest/runs/2026-05-01-1654-3p/issues/`. Many likely
   resolved by recent commits — sweep with Briggsy in the loop for
   closure claims.
