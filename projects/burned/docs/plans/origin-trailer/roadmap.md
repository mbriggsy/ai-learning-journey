...
- 🟡 **Deepening pass (all 8 phases, sequentially):** in progress.
  ...
  - ✅ Phase 3 DEEPENED 2026-05-17 (this commit) — 69 amendments, 5 tiers, 1737→4379 lines (2.52× growth ratio), +1 new unit (3.0 vocabulary vendoring); roadmap ADR #2 refined + NEW ADR #15 (public-directory architecture).
  - ⏸ Phase 4 deepening — next action.
