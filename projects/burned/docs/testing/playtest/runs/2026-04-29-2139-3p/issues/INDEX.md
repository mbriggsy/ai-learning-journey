...
| [022-direct-order-card-played-freeplay](022-direct-order-card-played-freeplay.md) | direct-order target sees silent double-draw — no "under attack" indicator | P2 | RESOLVED | — | resolved by `ad4bce5c` — SmartActionBox surfaces forced-draw count |
