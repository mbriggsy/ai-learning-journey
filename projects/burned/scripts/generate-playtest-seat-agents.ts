...
model: sonnet
tools: mcp__${ns}__browser_navigate, mcp__${ns}__browser_snapshot, mcp__${ns}__browser_click, mcp__${ns}__browser_fill_form, mcp__${ns}__browser_type, mcp__${ns}__browser_press_key, mcp__${ns}__browser_wait_for, mcp__${ns}__browser_take_screenshot, mcp__${ns}__browser_hover, mcp__${ns}__browser_select_option, Write
color: orange
---
