...
Probed: 2026-05-19T00:32:18.978Z
Env loaded from: `C:\Users\brigg\ai-learning-journey\projects\burned\.env`

## Per-engine results

- **elevenlabs**: OK — tier=creator, tts ok (17598 bytes)
- **openai**: OK — model scope ok, tts ok (26496 bytes)
- **gemini**: OK — model gemini-3.1-flash-tts-preview ok, tts endpoint ok

## Char-budget tracker

- Month: 2026-05
- ElevenLabs chars used: 4,112 / 100,000
