...
Generated: 2026-05-22T00:01:46.900Z
Composition fps: 30
...
| `s02-cue-219-dash.wav` | sustained | 351 | 362 | 3.1% | ±5% | OK |
| `s03-cue-570-dash.wav` | sustained | 270 | 547 | 102.6% | ±5% | FAIL |
...
| `s04-cue-1200-dash.wav` | list | 90 | 168 | 86.7% | ±7% | FAIL |
| `s04-cue-1290-dash.wav` | list | 120 | 137 | 14.2% | ±7% | FAIL |
| `s04-cue-1410-dash.wav` | list | 150 | 175 | 16.7% | ±7% | FAIL |
| `s04-cue-1560-dash.wav` | list | 120 | 134 | 11.7% | ±7% | WARN |
| `s04-cue-1680-dash.wav` | list | 180 | 175 | -2.8% | ±7% | OK |
| `s04-cue-1950-dash.wav` | payoff | 60 | 65 | 8.3% | ±4% | FAIL |
| `s05-cue-2280-dash.wav` | sustained | 150 | 118 | -21.3% | ±5% | FAIL |
| `s05-cue-2400-dash.wav` | scream | 50 | 72 | 44.0% | ±20% | FAIL |
| `s06-cue-2580-dash.wav` | payoff | 222 | 161 | -27.5% | ±4% | FAIL |
| `s06-cue-2814-dash.wav` | payoff | 12 | 36 | 200.0% | ±4% | FAIL |
