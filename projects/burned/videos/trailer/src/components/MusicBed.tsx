 ...
 * the Unit 2.7 Tier-4 TOTAL_FRAMES expansion (2850 → 3180). Anchors
 * before frame 1380 unchanged; anchors at/after the new S04_START
 * shifted +330 to preserve the cascade-build-peak-payoff envelope
 * shape relative to scene events.
 *
 ...
 * (no zipper noise). The 5 pp ramp 0.30→0.25 over frames 2325→2340
 * lands a true breath at the payoff before recovering smoothly
 * through the visual cut. DO NOT add an audio crossfade at the cut.
 *
 * Frame anchors + target volumes (post-Tier-4):
 ...
 *  2010        0.75  mid-cascade swell
 *  2190        0.90  peak intensify
 *  2280        0.90  STACKED_PAYOFF_FRAME — peak hold
 *  2325        0.30  sharp drop pre-silence
 *  2340        0.08  PAYOFF_VO_END — silence beat (true breath)
 ...
 */
const ENVELOPE_FRAMES = [0, 60, 210, 570, 1380, 2010, 2190, 2280, 2325, 2340, 2370, 2865, 2910, 3120, 3179] as const
