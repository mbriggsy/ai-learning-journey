...
**Status:** **ALL phases (−1 through 9) are deepened + doc-reviewed.** The house-rule gate ("no code until all plans deepened + contradictions resolved") is now **satisfied** — execution can begin (start with Preflight −1, below). No deepening pending.
