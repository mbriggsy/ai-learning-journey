...
- **Iter 4 split:** Agent 4 had grown to 12 checks across 3 distinct jobs (duplication + contradiction + presentation). Split into Agent 4 (duplication, 5 checks) + Agent 5 (consistency, 7 checks). Principle: group by PURPOSE not METHOD. Coverage maintained at 100%, reports are cleaner and more focused.
