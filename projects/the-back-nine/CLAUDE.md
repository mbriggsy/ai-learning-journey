...
5. **Backlog — *everything still open*** (the full tiered register — 43 open items, consolidated 2026-08-02 from a source audit + an archive salvage and re-anchored the same day against the shipped code; each traced to its raw obligations): [`docs/backlog.md`](docs/backlog.md).
