...
| The verified reference numbers (Trinity/Bengen, tax, ACA/IRMAA, the Medicare cost trend) | [research/engine-validation-and-tax.md](research/engine-validation-and-tax.md) · [pre65-healthcare.md](research/pre65-healthcare.md) · [medicare-cost-trend.md](research/medicare-cost-trend.md) |
