...
- ⚑ **RETITLED 2026-08-02 — the filed claim ("cannot be seen") is HALF FALSE and the truth is worse.**
  It IS disclosed: `recommendationView.ts:88-91` → `copy.ts:2702-2703` → `RecommendationSurface.tsx:477-487`.
...
- ✅ **(XS) SHIPPED 2026-08-02 — the dead-end clause is GONE.** `copy.ts:2702-2703` now states the
  ...
  `copy.ts:2894-2895` under the comment at `:2884-2893` that states the both-ways coupling.
...
- An interrupted intake loses the entire household — no draft persistence, no resume, and the tool promises "about five minutes"
  ...
  - ⚑ Accepted residuals of the warn half (2026-09-03 review; each bounded, none a build without a
    ...
    run" (`plans/2-first-answer.md:68`, `model.ts:1673-1675`) with no test that would catch it — a
...
- **🟡 Error copy speaks to the absurd reading:** birth year "62" → "Ages past 119 are beyond what
  ...
  `ACCOUNT_KINDS` `model.ts:1432-1440` + labels `copy.ts:297-303` · `copy.accountSave` rendered
