...
- ⚑ **RETITLED 2026-08-02 — the filed claim ("cannot be seen") is HALF FALSE and the truth is worse.**
  It IS disclosed: `recommendationView.ts:88-91` → `copy.ts:2741-2742` → `RecommendationSurface.tsx:477-487`.
...
- ✅ **(XS) SHIPPED 2026-08-02 — the dead-end clause is GONE.** `copy.ts:2741-2742` now states the
  ...
  `copy.ts:2933-2934` under the comment at `:2918-2927` that states the both-ways coupling.
...
### The pair's ONE clause wraps at two measures — capped at 36 rem in the assumptions panel, full stage width on the Roth sheet
