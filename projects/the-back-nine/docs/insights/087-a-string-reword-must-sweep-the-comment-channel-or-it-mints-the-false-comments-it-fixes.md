...
The O14 sweep's own council found a comment at `copy.ts:141` claiming a drift-pin
...
is not noise: it is a false claim a future maintainer will act on (the `copy.ts:141` case
