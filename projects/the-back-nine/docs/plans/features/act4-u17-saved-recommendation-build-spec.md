...
attributing that quantity to the save (`staleness.ts:26`, `resultSave.ts:172`, `copy.ts:2825`,
...
(`recommendationView.ts:697-703`, `copy.ts:2975` — the slot was renamed `recDeltaVizAria` 2026-09-08; re-anchored 2026-09-10). The
