...
attributing that quantity to the save (`staleness.ts:26`, `resultSave.ts:172`, `copy.ts:2845`,
...
(`recommendationView.ts:697-703`, `copy.ts:2995` — the slot was renamed `recDeltaVizAria` 2026-09-08; re-anchored 2026-09-10). The
