...
| **Tests** | 1629 vitest across 92 files (Vitest 4, `globals:false`); externally-derived goldens, absence-tests paired with presence companions | `pnpm test` |
...
**Act 3 (Controls, U9–U13) is the next build** — start at [docs/plans/3-controls.md](plans/3-controls.md), U9 (the budget builder) first. The standing **hard pre-Act-3 gate** (council 2026-06-29): before the U10 Roth-conversion lever ships, a real engine-produced non-monotone seed must render through the LIVE odds-ladder and pass the N=1 cold-read. Act 4 (Recommendation) — the actual differentiator — follows Act 3.
