...
export const acaEnhancedSubsidyStatus = sourced(
  {
    ...
    pendingExtension:
      'H.R. 1834 (a shell vehicle; the ACA substance arrived by substitute) passed the House 2026-01-08 (230–196) and has sat on Senate Legislative Calendar No. 319 since 2026-02-10 — THE SENATE HAS NEVER VOTED ON IT (the S 3385 cloture failure, 51–48, PREDATES it by four weeks and is not the answer to it), and when the must-pass Senate CR (H.R. 6500) passed 90–6 on 2026-08-08 not one of its 13 filed amendments touched §36B — that CR became Pub. L. 119-103 on 2026-09-02 (the House concurred 370–48 on 2026-09-01, a straight concurrence) carrying ZERO §36B text, the forecast Sept 14–30 attachment window closed empty, the next must-pass cliff is its §106(3) date of December 11, 2026, and the law ceiling stands at 119-108 with all six new laws swept clean at enrolled text. NOT enacted as of 2026-09-14; a later enactment WOULD be retroactive to all of 2026 (H.R. 1834 §1(c) is tax-year based), but only for months the household actually PAID a Marketplace premium (§36B(c)(2)(A)), and it runs only THROUGH TAX YEAR 2028 — §1(a)/(b) substitute “before January 1, 2029”, so the toggle it would flip is a three-year extension, never a permanent restoration',
