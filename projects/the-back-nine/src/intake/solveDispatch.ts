 ...
 *     WIDER than "zero pre-tax dollars" (review wf_6f89fe6f-35a P1): candidates.ts:389 rejects every
...
export function buildSolveRequest(draft: ScenarioDraft, todayEpochDay: number): SolveRequest | SolveBlockReason {
  ...
  // pool below every rail-anchored amount (candidates.ts:389) lands here too — the note speaks "not
