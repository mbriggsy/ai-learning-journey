...
export const ASSET_PROMPTS = [
  ...
  {
    name: 'role-mob-boss',
    promptSuffix: `portrait of a menacing 1940s crime boss, narrow shoulders visible, face completely lost in deep black shadow with no eyes visible only a cruel jaw and faint smirk, one hand raised near chin holding a lit cigar with a massive gold signet ring visible, crystal bourbon glass held in the other hand near chest, thick cigar smoke swirling around him, arms close to body not spread wide, intimidating and dangerous, half-body shot, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 768,
    targetHeight: 1024,
    aspectRatio: '3:4',
    needsTransparency: true,
  ...
  },
  {
    ...
    promptSuffix: `massive imposing 1940s crime boss, barrel-chested enormous figure in an immaculate white pinstripe suit and blood-red tie, completely bald, one massive ring-adorned hand resting on a mahogany desk, face half-lit from a single desk lamp, radiates absolute authority and menace, half-body shot centered, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 768,
    targetHeight: 1024,
    aspectRatio: '3:4',
    needsTransparency: true,
  ...
  },
  {
    ...
    promptSuffix: `full silhouette of a massive broad-shouldered man in a long overcoat and wide-brimmed fedora, completely shrouded in shadow, only a glowing cigar tip visible, looming figure backlit by a city window showing rain, deeply mysterious and threatening presence, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 768,
    targetHeight: 1024,
    aspectRatio: '3:4',
    needsTransparency: true,
