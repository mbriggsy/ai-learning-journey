...
export const ASSET_PROMPTS = [
  ...
  // --- Named Policy Cards: Virtuous (15) ---
  {
    ...
    promptSuffix: `1940s school cafeteria scene, children sitting at long tables eating lunch, warm sunlight through windows, a kind lunch lady serving from a pot, wholesome community feeling, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    name: 'public-library-expansion',
    promptSuffix: `grand 1940s public library interior, tall arched windows, rows of wooden bookshelves, reading lamps casting warm pools of light, a blueprint of a new wing on a table, civic pride, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s harbor waterfront at dawn, workers on docks clearing debris, clean water reflecting morning light, fishing boats, cranes and rope coils, community effort scene, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s city park with an iron memorial arch, stone benches, neat flower beds, an American flag on a pole, autumn leaves, solemn and dignified atmosphere, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s small-town medical clinic, a doctor with a stethoscope at a wooden desk, medicine bottles on shelves, warm lamp light, a sign reading FREE CLINIC, compassionate atmosphere, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `shiny 1940s electric streetcar on tracks through a city boulevard, overhead wires, passengers boarding, Art Deco storefronts, clean civic infrastructure, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s fire station with a gleaming red fire engine, brass fittings, fire helmets hanging on hooks, dalmatian dog, sense of civic duty and readiness, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s brick orphanage building being renovated, scaffolding, fresh paint, new windows, children playing in front yard, hopeful atmosphere, warm afternoon light, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s waterfront boardwalk along a river, wrought-iron lampposts, wooden benches, couples strolling, boats in the distance, golden sunset reflections on water, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s radio studio with a large art deco microphone, ON AIR light glowing, sound equipment, records stacked, broadcast tower visible through window, civic communication, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s steel truss bridge over a river, an engineer with a clipboard inspecting rivets, hard hat, sturdy construction, safe infrastructure, industrial scene, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s community garden in an urban lot, raised wooden beds with vegetables, picket fence, a woman in an apron tending plants, sunflowers, cheerful neighborhood scene, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s school band room, brass instruments on stands, a grand piano, sheet music scattered, a conductor's baton on the music stand, warm nostalgic atmosphere, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `row of ornate cast-iron street lamps illuminating a 1940s city sidewalk at dusk, warm golden glow, cobblestone street, sense of safety and civility, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s city hall desk with stacked coins and bills, an official ledger book, a rubber stamp marked APPROVED, a small American flag, sense of government aid and emergency support, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  ...
  // --- Named Policy Cards: Corrupt (15) ---
  {
    ...
    promptSuffix: `dark 1940s dockside at night, shadowy figures exchanging a thick envelope of cash near shipping crates, fog rolling in, a lone dock lamp, illicit deal, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s backroom poker table with stacked chips and cards, a city license document with a red APPROVED stamp, cigar smoke, green felt, corruption in high places, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `dark 1940s police evidence room, file cabinets with drawers pulled open, documents burning in a waste bin, badge on the desk, cover-up scene, ominous atmosphere, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s speakeasy being raided, barrels of liquor being smashed with axes, agents in trench coats, broken bottles, authoritarian enforcement scene, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s factory exterior with locked gates, a chain and padlock, discarded picket signs on the ground, factory smokestacks, workers turned away, oppressive atmosphere, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s tenement buildings being demolished, a wrecking ball swinging, dust clouds, displaced belongings on the sidewalk, a corrupt developer's plans on a clipboard, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s city hall at midnight, a single lit window, a shadowy figure signing documents by lamplight, rubber stamp, a city map on the wall with red zone markings, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `ominous 1940s scene, an empty chair under a single hanging light bulb, rope coiled on the floor, a hat left behind on the chair, threatening atmosphere, disappearance implied, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s office desk with an open safe showing stacks of money, police pension fund ledger with altered numbers, fountain pen, reading glasses, white-collar crime, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s customs office at the docks, crates stamped EXEMPT, a customs officer looking away while contraband passes through, clipboards and bribe money, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s courthouse backroom, a judge's gavel on a stack of cash, case files scattered, a shadowy handshake between silhouettes, justice for sale, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s accountant's office, two sets of books on the desk, one hidden in a drawer, dim green banker's lamp, columns of numbers, financial deception, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s luxury yacht moored at a private dock, champagne glasses, a city tax document with a large EXEMPT stamp, wealthy excess while the city crumbles, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s city payroll office, a long ledger with fictitious names, phantom employees, rubber stamp AUTHORIZED, empty desks in rows, bureaucratic fraud, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
  {
    ...
    promptSuffix: `1940s courtroom with empty jury box, a shadowy hand placing name cards in a specific order, scales of justice tilted, dark atmosphere of a rigged trial, ${CHROMA_BG_SUFFIX}`,
    targetWidth: 384, targetHeight: 512, aspectRatio: '3:4',
    needsTransparency: true, postProcess: { kind: 'chroma-key-then-resize' },
    format: 'webp', outputSubDir: 'cards',
  },
