...
const STATS = [
  ...
  { label: 'LINES OF PLANNING', value: 10000 },
  ...
  { label: 'TOTAL API COST', value: 2, suffix: ' dollars' },
];

/**
 * S13: The Stats (12s / 360 frames)
 * Full stat roll-up. $2 API cost is the mic drop.
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: NOIR.black }}>
      ...
      <AbsoluteFill style={{ justifyContent: 'flex-end', alignItems: 'center', paddingBottom: 40 }}>
        <TextReveal text="8 NIGHTS FROM CONCEPT TO DEPLOYMENT" startFrame={250} durationFrames={30}
